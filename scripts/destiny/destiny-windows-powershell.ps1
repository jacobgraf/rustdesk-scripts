...
$rustdesk_pw=(-join ((65..90) + (97..122) | Get-Random -Count 32 | % {[char]$_}))
...
function getLatest()
{
    ...
    # Current example link: https://github.com/rustdesk/rustdesk/releases/download/1.3.7/rustdesk-1.3.7-x86_64.exe
